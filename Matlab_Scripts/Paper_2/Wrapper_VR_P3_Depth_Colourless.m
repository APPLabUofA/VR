...
exp.pathname = 'M:\Data\VR_P3_Five_Depth_Colourless';
if exp.participant_set == 1
     exp.participants = {'000'};
elseif exp.participant_set == 2
     exp.participants = {'001','002'};
elseif exp.participant_set == 3
     exp.participants = {'000'};
end
...
elseif condition_set == 2 
    exp.name = 'VR_P3_Five_Depth_Far'
    if exp.trigger_set == 1
        %%%%%Triggers to tone onset%%%%%
        exp.events = {[101];...
            [102];...
...
exp.settings = 'VR_P3_Depth_Colourless_ERP';
